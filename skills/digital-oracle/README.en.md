...
> **Vendored from [komako-workshop/digital-oracle](https://github.com/komako-workshop/digital-oracle)** @ `2d2b83f` (2026-04-14). MIT License — see [LICENSE](LICENSE). All copyright remains with the upstream author; this directory is a vendored copy inside `openclaw-trader` and carries no additional authorship claim.
