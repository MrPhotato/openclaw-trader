...
> **Vendored from [komako-workshop/digital-oracle](https://github.com/komako-workshop/digital-oracle)** @ `2d2b83f` (2026-04-14). MIT License. Full license text in [LICENSE](LICENSE). 原作者著作权归属 `komako-workshop`；本目录内的一切代码与文档版权归上游所有，`openclaw-trader` 仓库仅作为 vendored 副本引入，不做任何变更以外的署名主张。
