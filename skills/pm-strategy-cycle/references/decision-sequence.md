...
`flip_triggers` means the specific conditions that would not just invalidate the current thesis, but justify flipping directional bias from long to short, short to long, or from active risk to flat/only_reduce.
