...
def build_system_settings_from_paths(paths) -> SystemSettings:
    ...
    return SystemSettings(
        ...
        execution=ExecutionSettings(
            ...
            max_order_share_pct_of_exposure_budget=float(perps_payload.get("max_order_share_pct_of_exposure_budget", 66.0)),
            max_position_share_pct_of_exposure_budget=float(perps_payload.get("max_position_share_pct_of_exposure_budget", 100.0)),
