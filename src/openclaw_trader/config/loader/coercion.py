...
def coerce_system_settings(source: object | None) -> SystemSettings:
    ...
    return SystemSettings(
        ...
        execution=ExecutionSettings(
            ...
            max_order_share_pct_of_exposure_budget=float(getattr(perps, "max_order_share_pct_of_exposure_budget", 66.0)),
            max_position_share_pct_of_exposure_budget=float(getattr(perps, "max_position_share_pct_of_exposure_budget", 100.0)),
